        ...
        map(([unshiftWith2, sizes2]) => {
          ...
          if (groupedMode) {
            ...
            while (prependedGroupItemsCount < unshiftWith2) {
              ...
              const groupItemCount = sizes2.groupIndices[groupIndex + 1] - theGroupIndex - 1;
              initialRanges.push({
...
var TableRoot = import_react.default.memo(function TableVirtuosoRoot(props) {
  ...
  return import_react.default.createElement(TheScroller, { ...props }, import_react.default.createElement(TheViewport, null, import_react.default.createElement(TheTable, { style: { borderSpacing: 0 }, ...contextPropIfNotDomElement(TheTable, context) }, [
    theHead,
    import_react.default.createElement(Items, { key: "TableBody" }),
    theFoot
  ])));
});
var {
